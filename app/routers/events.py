        ...
        if event.server_id == 0:
            ...
            if event.is_deleted == 0:
                ...
                existing_event_data = EventSync(
                    ...
                    start_time=int(existing_event.start_time.timestamp() * 1000),
                    end_time=int(existing_event.end_time.timestamp() * 1000),
                    priority=existing_event.priority,
                    location=existing_event.location,
                    created_at=int(existing_event.created_time.timestamp() * 1000),
                    updated_at=int(existing_event.updated_time.timestamp() * 1000),
